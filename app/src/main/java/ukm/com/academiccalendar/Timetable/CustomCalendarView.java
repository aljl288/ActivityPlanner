...
public class CustomCalendarView extends LinearLayout {
    ...
    public CustomCalendarView(final Context context, @Nullable AttributeSet attrs) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final EditText Description = addView.findViewById(R.id.eventdescription);
                ...
                AddEvent.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        SaveEvent(EventName.getText().toString(),Description.getText().toString(),EventTime.getText().toString(),date,month,year);
                        SetUpCalendar();
                        alertDialog.dismiss();
                    }
                });
    ...
    private void SaveEvent(String event,String description,String time,String date, String month,String year){

        dbOpenHelper = new DBOpenHelper(context);
        SQLiteDatabase database = dbOpenHelper.getWritableDatabase();
        dbOpenHelper.SaveEvent(event,description,time,date,month,year,database);
        dbOpenHelper.close();
