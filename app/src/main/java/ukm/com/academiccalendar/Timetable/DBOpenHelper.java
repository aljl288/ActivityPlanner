...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public void SaveEvent(String event,String description,String time,String date,String month,String year,SQLiteDatabase database){
    ...
    public void deleteEvent(String event,String description,String time,String date,SQLiteDatabase database){
        String selection = DBStructure.EVENT +"=? and " +DBStructure.DESCRIPTION +"=? and "+DBStructure.DATE +"=? and "+DBStructure.TIME +"=?";
        String[] selectionArg ={event,description,date,time};
